...
if __name__ == '__main__':
    ...
    with mlflow.start_run(run_name=model_class.get_name()):
        ...
        edge_acc_validation = evaluate_edge_accuracy(new_model_instance, dataset_retriever.get_validation_graphs())
        ...
        # Removed due to some graphs being to large for the given edge accuracy calculations!
        mlflow.log_metric("edge_acc_evaluation", edge_acc_validation)
